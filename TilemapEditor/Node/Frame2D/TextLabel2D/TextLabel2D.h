...
public:
	...
	GAME_TextLabel2D(std::string name, std::string font_path, vector2 position, vector2 size, vector2 anchor = 0, float font_scale = 0.05f, color4 background_color = 255, color4 border_color = 0, float border_size = 0) : GAME_Panel2D(name, position, size, anchor, background_color, border_color, border_size), GAME_TextData(font_path, font_scale) {}
